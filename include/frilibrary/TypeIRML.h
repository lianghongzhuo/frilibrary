...
//! <a href="http://www.springer.com/978-3-642-05174-6" target="_blank" title="You may order your personal copy at
...
public:
    ...
    //  ---------------------- Doxygen info ----------------------
    //! \fn int GetNextMotionState_Position(const double* CurrentPosition, const double* CurrentVelocity, const double*
    //! MaxVelocity, const double* MaxAcceleration, const double* TargetPosition, const bool* SelectionVector, double*
    //! NewPosition, double* NewVelocity)
    //!
    //! \brief
    ...
    //  ----------------------------------------------------------
    int GetNextMotionState_Position(const double* CurrentPosition, const double* CurrentVelocity,
                                    const double* MaxVelocity, const double* MaxAcceleration,
                                    const double* TargetPosition, const bool* SelectionVector, double* NewPosition,
                                    double* NewVelocity);
    ...
    //  ---------------------- Doxygen info ----------------------
    //! \fn int GetNextMotionState_Velocity(const double* CurrentPosition, const double* CurrentVelocity, const double*
    //! MaxAcceleration, const double* TargetVelocity, const bool* SelectionVector, double* NewPosition, double* NewVelocity)
    //!
    //! \brief
    //! Calculates new position \f$ \vec{P}_{i+1} \f$ and velocity
    ...
    //! \sa TypeIRML::TypeIRMLResult
    //  ----------------------------------------------------------
    int GetNextMotionState_Velocity(const double* CurrentPosition, const double* CurrentVelocity,
...
private:
    ...
    //  ---------------------- Doxygen info ----------------------
    //! \fn void SynchronizeTrajectory(const TypeIRMLMath::TypeIRMLInputParameters &IP, const double
    //! &SynchronizationTime, TypeIRMLMath::TypeIMotionPolynomials *PolynomialArray)
    //!
    //! \brief
    ...
    //  ----------------------------------------------------------
    void SynchronizeTrajectory(const TypeIRMLMath::TypeIRMLInputParameters& IP, const double& SynchronizationTime,
                               TypeIRMLMath::TypeIMotionPolynomials* PolynomialArray);

    //  ---------------------- Doxygen info ----------------------
    //! \fn int CalculateOutputValues( const TypeIRMLMath::TypeIMotionPolynomials *PolynomialArray, const
    //! TypeIRMLBoolVector &SelectionVector, TypeIRMLMath::TypeIRMLOutputParameters *OP)
    //!
    //! \brief
    ...
    int CalculateOutputValues(const TypeIRMLMath::TypeIMotionPolynomials* PolynomialArray,
                              const TypeIRMLBoolVector& SelectionVector, TypeIRMLMath::TypeIRMLOutputParameters* OP);
