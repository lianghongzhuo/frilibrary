...
public:
    ...
    //  ---------------------- Doxygen info ----------------------
    //! \fn TypeIRMLVector(const T &Component0, const T &Component1, const T &Component2, const T &Component3, const T
    //! &Component4)
    //!
    ...
    //  ----------------------------------------------------------
    TypeIRMLVector(const T& Component0, const T& Component1, const T& Component2, const T& Component3,
                   const T& Component4, const T& Component5)
    {
    ...
    //  ----------------------------------------------------------
    TypeIRMLVector(const T& Component0, const T& Component1, const T& Component2, const T& Component3,
                   const T& Component4, const T& Component5, const T& Component6)
    {
