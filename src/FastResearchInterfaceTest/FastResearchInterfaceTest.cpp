...
int main(int argc, char* argv[])
{
    ...
    float FloatValues[SIZE_USER_DATA], TmpFloatValues[SIZE_USER_DATA], DesiredTorqueValues[NUMBER_OF_JOINTS],
        ...
        CartStiffnessValues[NUMBER_OF_CART_DOFS], CartDampingValues[NUMBER_OF_CART_DOFS];
    ...
    FRI = new FastResearchInterface(
        "/Users/torsten/Documents/SourceCode/LWR_Public/LWR_Public/etc/980039-FRI-Driver.init");
#endif
    ...
    while (Run)
    {
        ...
        switch (c)
        {
            ...
            case 'L':
                ...
                printf("\nWould you like to enter one value for all vector elements (a) or for each individual one "
                       "(i)?\n");
